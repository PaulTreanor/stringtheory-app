...
Multi-touch - A technology allowing a touchscreen to detect and track two or more points of contact (usually the user&#39;s fingers) at once.

Chord- a group of (typically three or more) notes sounded together to make a new sound

Chord Shape -  the layout of notes being pressed when a user makes a specific chord. To play a C chord the guitarist plays a C chord shape.
